        ...
        <div className="h-screen overflow-y-auto bg-white text-slate-900 dark:bg-[#121212] dark:text-white">
            <section className="relative mx-auto max-w-3xl px-4 py-20">
                <div className="mb-16 text-center">
                    <h1 className="mb-3 text-sm text-blue-600 dark:text-blue-500">Privacy Policy</h1>
                    <h2 className="mb-4 text-4xl font-bold">We care about your privacy</h2>
                    <h3 className="text-zinc-700 dark:text-gray-300">
                ...
                <div className="mb-8">
                    <p className="mb-4 text-zinc-700 dark:text-gray-300">
                    ...
                    <p className="mb-4 text-zinc-700 dark:text-gray-300">
                        ...
                        Odit repudiandae rem, recusandae placeat suscipit non incidunt similique
                        optio facilis quae architecto minus iusto modi natus quod quidem
                        laboriosam unde error explicabo ullam! Enim unde iste, beatae, corrupti,
                        velit animi perferendis nisi maxime dolore qui aliquam.
                    </p>
                </div>
                <div className="mb-8">
                    ...
                    <p className="mb-4 text-zinc-700 dark:text-gray-300">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro at iusto
                        laboriosam possimus in! Repellendus ea accusantium omnis impedit
                        incidunt facere fuga consectetur quidem sint dolorem necessitatibus
                        corporis itaque sed qui voluptates amet, sunt fugit? Deleniti explicabo
                        et veniam alias eligendi similique, molestiae ipsa vitae rerum non
                        repudiandae accusamus error temporibus pariatur. Sit totam, odit facilis
                        adipisci ut vitae neque deserunt obcaecati. Laborum labore possimus ipsa
                        quo placeat, tempora voluptatibus commodi itaque quia cupiditate nihil
                        at, porro deleniti totam quaerat!
                    </p>
                    <p className="mb-4 text-zinc-700 dark:text-gray-300">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga
                        asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis.
                        A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur
                        veniam praesentium error qui necessitatibus. Et autem dolorum
                        consectetur officia, provident quasi soluta?
                    </p>
                </div>
                <div className="mb-8">
                    <h3 className="mb-4 text-xl font-bold sm:text-2xl md:text-3xl">
                ...
                <div className="mb-8">
                    ...
                    <ol className="list-decimal pl-4 text-zinc-700 dark:text-gray-300">
                        <li>
